"""
Extracts demographic data (Departments and Municipality/Cities) from datos.gov.co API for Colombia.
"""
import logging
import sys
...
def extract_data(
    ...
    while True:
        ...
        try:
            ...
            logging.error("An error ocurred while  making the request. Error: %s ", ce)
            sys.exit(1)
